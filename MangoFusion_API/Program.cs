...
internal sealed class BearerSecuritySchemeTransformer(IAuthenticationSchemeProvider authenticationSchemeProvider) : IOpenApiDocumentTransformer
{
    ...
    {
        var authenticationSchemas = await authenticationSchemeProvider.GetAllSchemesAsync();
        if (authenticationSchemas.Any(authScheme => authScheme.Name == JwtBearerDefaults.AuthenticationScheme))
        {
